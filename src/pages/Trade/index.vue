  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        >
        <p @click="changeDedault(userAddress, userAddressList)">
...
export default {
  ...
  methods: {
    ...
    //todo 修改默认地址（排他）
    changeDedault(userAddress, userAddressList) {
    ...
    async submitOrder() {
      ...
      let tradeData = {
        consignee: this.defaultUserAddress.phoneNum,
        consigneeTel: this.defaultUserAddress.userAddress,
        paymentWay: "ONLINE",
        orderComent: this.message,
